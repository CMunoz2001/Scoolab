            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">EDURED</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1">Bienvenido a EDURED 👋</h4>
              <p class="mb-6">Inicie sesión en su cuenta y acceda satisfactoriamente.</p>
